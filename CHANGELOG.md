...
- Fixed transient Xcode 26 `xctrace` segmentation faults leaving partial Instruments outputs and failing simulator collection; exit code 139 now triggers one clean retry, while all other errors still fail immediately.
