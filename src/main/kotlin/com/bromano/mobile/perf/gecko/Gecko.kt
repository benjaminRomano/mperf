...
data class GeckoProfile(
    val meta: GeckoMeta,
    // TODO: Look into having Gecko do symbolication
    ...
    fun toFile(output: Path) {
        ...
        GZIPOutputStream(FileOutputStream(output.toFile()))
...
class GeckoSample(
    ...
    fun toData() = arrayOf<Any?>(stackId, timeMs, eventDelay)
}
...
data class GeckoStack(
    ...
    fun toData() = arrayOf<Any?>(prefixId, frameId, category)
}
